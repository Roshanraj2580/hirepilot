      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-indigo-50 text-indigo-700 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={16} className="text-indigo-600" />
              AI Powered Hiring Practice Platform
            </div>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block'>
                <span className='bg-indigo-50 text-indigo-700 px-5 py-1 rounded-full'>
                  HirePilot
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-indigo-600 text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md'>
                Start Interview
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`
        relative bg-white rounded-2xl border-2 border-indigo-100 
