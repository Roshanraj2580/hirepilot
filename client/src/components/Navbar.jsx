...
function Navbar() {
  ...
  return (
    <div className='bg-slate-50 flex justify-center px-4 pt-6'>
        ...
        className='w-full max-w-6xl bg-white rounded-2xl shadow-sm border border-slate-200 px-8 py-4 flex justify-between items-center relative'>
            ...
            <div className='flex items-center gap-6  relative'>
                <div className='relative'>
                    <button onClick={()=>{
                        ...
                        setShowUserPopup(false)
                    }} className='flex items-center gap-2 bg-indigo-50 text-indigo-700 px-4 py-2 rounded-full text-md hover:bg-indigo-100 transition'>
                        <BsCoin size={20}/>
                        {userData?.credits || 0}
                    </button>
                    ...
                    {showCreditPopup && (
                        <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                            ...
                            <button onClick={()=>navigate("/pricing")} className='w-full bg-indigo-600 text-white py-2 rounded-lg text-sm'>Buy more credits</button>
