...
setIsSubmitting(false)
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-indigo-50 via-white to-sky-100 flex items-center justify-center p-4 sm:p-6'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
         ...
         {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
            ...
            disabled={isSubmitting}
              whileTap={{ scale: 0.95 }}
              className='flex-1 bg-gradient-to-r from-indigo-600 to-sky-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
            ...
            className='mt-6 bg-indigo-50 border border-indigo-200 p-5 rounded-2xl shadow-sm'>
              ...
              onClick={handleNext}
               ...
               className='w-full bg-gradient-to-r from-indigo-600 to-sky-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>
